...
const char *ssid = "Galaxy A51C220";    //silakan disesuaikan sendiri
const char *password = "kuke1080"; //silakan disesuaikan sendiri

const char *mqtt_server = "ec2-18-212-237-40.compute-1.amazonaws.com";
